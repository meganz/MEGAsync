...
SCENARIO("Scale factor calculation on linux platforms")
{
    ...
    {
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName", 1920, 1080, 96, 1.}}, "Ubuntu20");
    ...
    {
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName", 1920, 1080, 192, 1.}}, "Ubuntu20");
    ...
    {
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName", 3840, 2160, 96, 1.}}, "Ubuntu20");
    ...
    {
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName", 3840, 2160, 192, 1.}}, "Ubuntu20");
    ...
    GIVEN("A single screen with 3840x2160 resolution and display 200% scale with QT_AUTO_SCREEN_SCALE_FACTOR environtment variable set")
    {
        ...
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName", 1920, 1080, 192, 2.}}, "Ubuntu20");
    ...
    {
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName1", 1920, 1080, 96, 1.}, {"screenName2", 3840, 2160, 96, 1.}}, "Ubuntu20");
    ...
    {
        ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName1", 1920, 1080, 192, 1.}, {"screenName2", 3840, 2160, 192, 1.}}, "Ubuntu20");
    ...
    GIVEN("A two screen setup")
    {
        ...
        WHEN("Scale factor is set")
        {
            ...
            THEN("Loged messages can be retrieved")
            {
                ...
                std::vector<std::string> expectedLogMessages{"Ubuntu20"};
...
{
    unsetEnvirontmentVariables();
    ScaleFactorManager scaleFactorManager(OsType::LINUX, {{"screenName1", 1920, 1080, 192, 1.}, {"screenName2", 3840, 2160, 192, 1.}}, "osName");
    ...
    GIVEN("QT_SCALE_FACTOR environtment variable already set")
    {
        ...
        WHEN("Set scale factor is executed")
        {
            ...
            THEN("Environtment variable is left with the value already set")
            {
                ...
                {
                    std::vector<std::string> expectedLogMessages{"osName"};
