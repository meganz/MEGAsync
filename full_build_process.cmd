...
IF [%MEGA_QTPATH%]==[] (
	IF NOT [%MEGAQTPATH%]==[] (
		...
		SET MEGA_QTPATH=C:\Qt\5.15.12\x64
	)
)
...
echo MEGA_QTPATH environment variable should be set to the Qt install dir. Takes the value of MEGAQTPATH, or defaults to C:\Qt\5.15.12\x64
exit /B