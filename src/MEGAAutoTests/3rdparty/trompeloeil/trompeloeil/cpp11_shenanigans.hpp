...
struct make_integer_sequence_impl:
    iseq_if_c<
        ...
        iseq_if_c<N == 1, iseq_identity<integer_sequence<T, 0>>, make_integer_sequence_impl_<T, N>>>
{};
}
...
#define TROMPELOEIL_WITH_(capture, arg_s, ...) \
    template action<trompeloeil::with>( \
        arg_s, \
        [capture](typename trompeloeil_e_t::trompeloeil_call_params_type_t const& trompeloeil_x) \
        { \
            ...
            ::trompeloeil:: \
                ignore(_1, _2, _3, _4, _5, _6, _7, _8, _9, _10, _11, _12, _13, _14, _15); \
            return __VA_ARGS__; \
        })

#define TROMPELOEIL_SIDE_EFFECT_(capture, ...) \
    template action<trompeloeil::sideeffect>( \
        [capture](typename trompeloeil_e_t::trompeloeil_call_params_type_t& trompeloeil_x) \
        { \
            auto&& _1 = ::trompeloeil::mkarg<1>(trompeloeil_x); \
            auto&& _2 = ::trompeloeil::mkarg<2>(trompeloeil_x); \
            auto&& _3 = ::trompeloeil::mkarg<3>(trompeloeil_x); \
