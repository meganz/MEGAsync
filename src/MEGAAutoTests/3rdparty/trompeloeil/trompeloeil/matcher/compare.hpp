...
{
    return make_matcher<T>(lambdas::equal(), lambdas::equal_printer(), std::forward<V>(v));
}
...
{
    return make_matcher<T>(lambdas::not_equal(), lambdas::not_equal_printer(), std::forward<V>(v));
}
...
{
    return make_matcher<T>(lambdas::greater(), lambdas::greater_printer(), std::forward<V>(v));
}
...
{
    return make_matcher<T>(lambdas::less(), lambdas::less_printer(), std::forward<V>(v));
}
