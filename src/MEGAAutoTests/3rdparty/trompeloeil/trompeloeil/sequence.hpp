...
public:
    ...
    void validate_match(severity s,
...
public:
    ...
    sequence_matcher(char const* exp,
                     location loc,
    ...
    void validate_match(severity s, char const* match_name, location loc) const
    {
        seq.validate_match(s, this, seq_name, match_name, loc);
    }

    unsigned cost() const noexcept
    {
                                          ...
                                          location loc) const
{
    ...
    if (matchers.empty())
    {
        ...
        os << "Sequence mismatch for sequence \"" << seq_name << "\" with matching call of "
           << match_name << " at " << loc << ". Sequence \"" << seq_name
