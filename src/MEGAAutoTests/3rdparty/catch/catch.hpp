...
#define INTERNAL_CATCH_TEST_CASE_METHOD(ClassName, ...) \
    INTERNAL_CATCH_TEST_CASE_METHOD2(INTERNAL_CATCH_UNIQUE_NAME(C_A_T_C_H_T_E_S_T_), \
                                     ClassName, \
                                     __VA_ARGS__)
...
{
    m_rootTracker =
        std::make_shared<SectionTracker>(NameAndLocation("{root}", CATCH_INTERNAL_LINEINFO),
                                         *this,
                                         nullptr);
...
// Copyright CatchDistributed under the Boost Software License, Versi(See accompanying file
// LICENSE_1_0.txt or copy https://www.boost.org/LICENSE_1_0.txt)
