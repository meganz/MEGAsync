...
const QString Preferences::themeKey = QString::fromLatin1("theme");
...
const int Preferences::defaultTheme = static_cast<std::underlying_type<Theme>::type>(Theme::LIGHT_THEME);
...
void Preferences::setTheme(int theme)
{
