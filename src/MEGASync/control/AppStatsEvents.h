...
public:
    ...
    enum class EventType
    {
        ...
        TRANSFER_MANAGER_DOWNLOAD_CLICKED,
        LINK_STREAM_STARTED,
        UPGRADE_CLICKED_INFO_DIALOG,
        STORAGE_USAGE_CLICKED_INFO_DIALOG,
        NOTIFICATION_FILTERS_OPENED,
        NOTIFICATION_FILTER_SELECTED_ALL,
        NOTIFICATION_FILTER_SELECTED_CONTACTS,
        NOTIFICATION_FILTER_SELECTED_INCOMING_SHARES,
        NOTIFICATION_FILTER_SELECTED_PAYMENTS,
        NOTIFICATION_ITEM_CLICKED,
        UPGRADE_CLICKED_SETTINGS,
        SETTINGS_MY_ACCOUNT_CLICKED,
        SETTINGS_DETAILS_CLICKED,
        BACKUP_CHECKBOX_TOGGLED,
        SYNC_CHECKBOX_TOGGLED,
        SETTINGS_PERMISSIONS_CLICKED,
        UPGRADE_CLICKED_INFO_DIALOG_OVER_QUOTA_WARNING,
        BACKUP_ADDED_SETTINGS,
        BACKUP_ADDED_CONTEXT_MENU,
        BACKUP_ADDED_ONBOARDING,
        BACKUP_ADDED_MAIN_APP,
        BACKUP_ADDED_WEBCLIENT,
        SETTINGS_ISSUE_RESOLUTION_SMART,
        SETTINGS_ISSUE_RESOLUTION_ADVANCED,
        SETTINGS_VIEW_BACKUP_CLICKED,
        SETTINGS_DEVICE_CENTER_CLICKED,
        SETTINGS_SESSION_HISTORY_CLICKED,
        CLOUD_DRIVE_UPLOAD_CLICKED,
        TRANSFER_MANAGER_OPEN_LINKS_CLICKED,
        TRANSFER_MANAGER_UPLOAD_CLICKED,
        INFO_DIALOG_UPLOAD_CLICKED,
        TRANSFER_MANAGER_PAUSE_RESUME_CLICKED,
        TRANSFER_MANAGER_SETTINGS_CLICKED,
        BACKUP_ADDED_SHELL_EXTENSION,
        TARGETED_DISCOUNT_CAMPAIGN_STARTED,
        TARGETED_DISCOUNT_CAMPAIGN_STOPPED,
        TARGETED_DISCOUNT_DIALOG_SHOWN,
        TARGETED_DISCOUNT_DIALOG_DISMISSED,
        TARGETED_DISCOUNT_DIALOG_DEAL_GRABBED,
        TARGETED_DISCOUNT_INFODIALOG_BUTTON_CLICKED,
        MACOS_ARM64_UPDATE_URL_ADJUSTED_FOR_INTEL_BINARY,
        MIGRATION_TOOL_OPENED_FROM_ONBOARDING,
        MIGRATION_TOOL_OPENED_FROM_MENU,
        ONBOARDING_LOGIN_OK,
        ONBOARDING_FETCHNODES_COMPLETED,
        ONBOARDING_FETCHNODES_SLOW_20_60S,
        ONBOARDING_FETCHNODES_SLOW_1_5MIN,
        ONBOARDING_FETCHNODES_SLOW_OVER_5MIN,
        ONBOARDING_FETCHNODES_FAILED,
        ONBOARDING_FETCHNODES_TIMEOUTS_CS,
        ONBOARDING_FETCHNODES_TIMEOUTS_SC,
        ONBOARDING_FETCHNODES_STALLED_PREVIOUS_SESSION,
        HEARTBEAT_TIMEOUT_CS_FIRST_IN_SESSION,
        HEARTBEAT_TIMEOUT_SC_FIRST_IN_SESSION,
    };
    Q_ENUM(EventType)
