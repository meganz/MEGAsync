...
{
    connect(this, &QTimer::timeout, this, &IntervalTimer::onTimeout);
}

IntervalTimer::IntervalTimer(int64_t expirationTimeSecs, QObject* parent)
    : QTimer(parent)
    , mLastTimeInterval(0)
{
    connect(this, &QTimer::timeout, this, &IntervalTimer::onTimeout);
...
int64_t IntervalTimer::getRemainingTime() const
{
...
void IntervalTimer::singleShot(int64_t remainingTimeSecs)
{
