...
const char Preferences::USER_AGENT[] = "MEGAsync/5.0.16.0";
const int Preferences::VERSION_CODE = 5016;
const int Preferences::BUILD_ID = 0;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("5.0.16");
QString Preferences::SDK_ID = QString::fromAscii("2be1a15");
