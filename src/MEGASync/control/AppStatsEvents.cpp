...
QMap<AppStatsEvents::EventType, int> AppStatsEvents::mTypeMap = {
 ...
 //{ (Stalled issues reserved)                                          , 99550 },
  ...
  //{ (Stalled issues reserved)                                          , 99565 },
    ...
    {AppStatsEvents::EventType::SYNC_ADDED_CLOUD_DRIVE_BUTTON,              600032},
    {AppStatsEvents::EventType::CLOUD_DRIVE_DIALOG_OPEN,                    600033}
};
...
QMap<AppStatsEvents::EventType, const char*> AppStatsEvents::mMessageMap = {
    ...
    {AppStatsEvents::EventType::CLOUD_DRIVE_DIALOG_OPEN,                    "Cloud drive dialog open"                  }
};
