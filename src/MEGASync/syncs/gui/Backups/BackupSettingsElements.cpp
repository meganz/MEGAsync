...
void BackupSettingsElements::initElements(SyncSettingsUIBase* syncSettingsUi)
{
    ...
    connect(openFolderUi->bOpenBackupFolder,
            &QPushButton::clicked,
            this,
            &BackupSettingsElements::onOpenBackupFolderClicked);

    auto myBackupsHandle = UserAttributes::MyBackupsHandle::requestMyBackupsHandle();
    connect(myBackupsHandle.get(),
            &UserAttributes::MyBackupsHandle::attributeReady,
            this,
            &BackupSettingsElements::onMyBackupsFolderHandleSet);
