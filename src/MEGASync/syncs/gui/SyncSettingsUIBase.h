...
public slots:
    void addButtonClicked(mega::MegaHandle megaFolderHandle = mega::INVALID_HANDLE) const;
#ifndef Q_OS_WINDOWS
...
protected:
    ...
    virtual void addSyncAfterOverQuotaCheck(mega::MegaHandle megaFolderHandle = mega::INVALID_HANDLE) const = 0;
