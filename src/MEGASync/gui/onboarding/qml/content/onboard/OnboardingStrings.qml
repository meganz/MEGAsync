...
QtObject {
    ...
    readonly property string confirmBackupErrorDuplicated: qsTr("There is already a folder named \"\" in this backup")
    readonly property string confirmBackupErrorRemote: qsTr("A folder named \"\" already exists on your backups")
