...
保管されたデータへのアクセスを回復したり、MEGAアカウントを新規サインアップしたりすることはできません。</translation>
    ...
    <message>
        ...
        <translation>[B]エラーが検出されました[/B][BR]アプリケーションリソースの読み込み中にエラーが発生しました。アプリを終了してください。このエラーが複数回発生する場合は、[A]mega.io/desktop[/A]からアプリを再インストールするか、サポートにご連絡ください。</translation>
    </message>
</context>
<context>
