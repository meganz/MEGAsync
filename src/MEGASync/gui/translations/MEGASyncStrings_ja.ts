...
- Fixed other bugs and made assorted other improvements.
        ...
        <translation>－同期競合の処理を改善しました。
－問題解決における障害管理を改善しました。
－問題解決ダイアログを改善しました。
－デフォルトの自動問題解決を追加しました。
－新しいUIの改善点を追加しました。
－他のバグを修正し、その他のさまざまな改善を行いました。</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translatorcomment>Description of a new improvement shown in whats new dialog .con-703</translatorcomment>
        <translation>同期の問題を完全に可視化し、競合の解決方法を完全に制御できるようになりました。</translation>
    </message>
    <message>
        ...
        <translatorcomment>Description of a new improvement shown in whats new dialog .con-703</translatorcomment>
        <translation>まったく新しいインターフェイスを使用して同期とバックアップをカスタマイズし、ファイルとフォルダを除外できます。詳細設定を使用すると、同期とバックアップごとに独自の除外ルールを作成できます。</translation>
    </message>
    <message>
