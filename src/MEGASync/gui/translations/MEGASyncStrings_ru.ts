...
- Bug fixes and performance improvements.
        ...
        <translation>- Улучшен пользовательский интерфейс и взаимодействие с менеджером передач.
- В диалоговом окне исключений добавлена поддержка подстановочных знаков.
- Обновлены сторонние зависимости Qt.
- Новые выпуски для Raspberry Pi OS.
- Исправлены сбои из-за отсутствующих или неисправных драйверов OpenGL в Windows.
...
<context>
    ...
    <message>
        ...
        <translation>[B]Хранилище почти заполнено[/B][BR][A]Улучшите аккаунт[/A], пока оно не заполнилось, а загрузки, синхронизация и резервное копирование не остановились.</translation>
    </message>
    <message>
        ...
        <translation>[B]Хранилище заполнено[/B][BR]Загрузки отключены, а синхронизация и резервное копирование приостановлены.</translation>
    </message>
    <message>
