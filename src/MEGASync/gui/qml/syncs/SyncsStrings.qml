...
QtObject {
    ...
    readonly property string fullSyncButtonDescription: qsTranslate("OnboardingStrings", "Sync your entire MEGA account with your local device.")
    ...
    readonly property string selectiveSyncButtonDescription: qsTranslate("OnboardingStrings", "Sync selected folders in your MEGA account with your local device.")
