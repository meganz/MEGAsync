...
QtObject {
    ...
    readonly property string nzdPerMonth: qsTr("NZD per month")
    readonly property string nzdPerYear: qsTr("NZD per year")
    readonly property string perMonth: qsTr("per month")
    readonly property string perYear: qsTr("per year")
    readonly property string priceEuro: qsTr("€X.XX*")
    readonly property string priceDollar: qsTr("$X.XX*")
