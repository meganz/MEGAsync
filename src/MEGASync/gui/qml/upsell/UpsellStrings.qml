...
QtObject {
    ...
    readonly property string storageText: qsTr("Upgrade your account to get more storage quota.[BR][BR]Or delete some files and [A]empty your rubbish bin[/A] to free up storage space.")
