...
Item {
    ...
    readonly property string accountTypeStarter: qsTranslate("Utilities", "Starter")
    readonly property string accountTypeBasic: qsTranslate("Utilities", "Basic")
    readonly property string accountTypeEssential: qsTranslate("Utilities", "Essential")
