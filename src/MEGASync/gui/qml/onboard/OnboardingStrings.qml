...
QtObject {
    ...
    readonly property string fullSyncButtonDescription: qsTr("Sync your entire MEGA Cloud drive with your local device.")
    ...
    readonly property string selectiveSyncButtonDescription: qsTr("Sync selected folders in your MEGA Cloud drive with your local device.")
