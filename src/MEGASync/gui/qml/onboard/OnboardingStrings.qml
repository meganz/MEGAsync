...
QtObject {
    ...
    readonly property string backupButtonDescription: qsTr("Data from your device will automatically and consistently back up to MEGA in real-time. Files deleted from your computer will be deleted from MEGA.")
    ...
    readonly property string importFromAnotherCloud: qsTr("Import from another cloud")
    ...
    readonly property string syncButtonDescription: qsTr("Access the latest version of your files from anywhere. Changes made to synced files will automatically update in both directions.")
    ...
    readonly property string cancelAccountCreationTitle: qsTr("Cancel account creation?")
    readonly property string cancelAccountCreationBody: qsTr("Closing this window will cancel the sign up process.")
    readonly property string cancelAccountAcceptButton: qsTr("Cancel account")
    readonly property string cancelAccountCancelButton: qsTr("Don’t cancel")
    ...
    readonly property string passwordEasilyGuessedError: qsTr("Your password is too easily guessed. You need to make it stronger.")
    readonly property string passwordEasilyGuessed: qsTr("Your password is easily guessed. You need to make it stronger.")
    ...
    readonly property string finalPageButtonImportFromCloud: qsTr("Move your files from Google Drive straight into MEGA, fully encrypted. Start in a few clicks.")
