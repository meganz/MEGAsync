    ...
    QTransfersModel(type, parent)
{
    ...
    connect(((MegaApplication *)qApp), SIGNAL(clearAllFinishedTransfers()), this, SLOT(removeAllTransfers()));
    connect(((MegaApplication *)qApp), SIGNAL(clearFinishedTransfer(int)), this, SLOT(removeTransferByTag(int)));
