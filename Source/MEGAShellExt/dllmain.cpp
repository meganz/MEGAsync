...
const TCHAR ShellExtSyncedFriendlyName[] = L"###MegaShellExtSynced";
...
const TCHAR ShellExtPendingFriendlyName[] = L"###MegaShellExtPending";
...
const TCHAR ShellExtSyncingFriendlyName[] = L"###MegaShellExtSyncing";
