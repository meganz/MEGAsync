...
TRANSLATIONS = \
    ...
    gui/translations/MEGASyncStrings_ca.ts \
    gui/translations/MEGASyncStrings_cs.ts \
    gui/translations/MEGASyncStrings_da.ts \
    ...
    gui/translations/MEGASyncStrings_ms.ts \
    gui/translations/MEGASyncStrings_nl.ts \
    gui/translations/MEGASyncStrings_no.ts \
    ...
    gui/translations/MEGASyncStrings_af.ts \
    gui/translations/MEGASyncStrings_bg.ts \
    gui/translations/MEGASyncStrings_bs.ts \
    gui/translations/MEGASyncStrings_cy.ts \
    gui/translations/MEGASyncStrings_el.ts \
    gui/translations/MEGASyncStrings_eu.ts \
    gui/translations/MEGASyncStrings_hi.ts \
    gui/translations/MEGASyncStrings_hr.ts \
    gui/translations/MEGASyncStrings_ka.ts \
    gui/translations/MEGASyncStrings_lv.ts \
    gui/translations/MEGASyncStrings_lt.ts \
    gui/translations/MEGASyncStrings_mi.ts \
    gui/translations/MEGASyncStrings_mk.ts \
    gui/translations/MEGASyncStrings_sl.ts \
    gui/translations/MEGASyncStrings_tl.ts \
    gui/translations/MEGASyncStrings_vn.ts
