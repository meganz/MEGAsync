...
const char Preferences::USER_AGENT[] = "MEGAsync/1.0.35.21";
const int Preferences::VERSION_CODE = 1035;
const int Preferences::BUILD_ID = 21;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("1.0.36");
