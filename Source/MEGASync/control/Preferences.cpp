...
const int Preferences::defaultTransferDownloadMethod      = Preferences::TRANSFER_METHOD_AUTO;
const int Preferences::defaultTransferUploadMethod        = Preferences::TRANSFER_METHOD_AUTO;
