...
const char Preferences::USER_AGENT[] = "MEGAsync/1.0.31";
const int Preferences::VERSION_CODE = 1031;
const int Preferences::BUILD_ID = 0;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("1.0.31");
