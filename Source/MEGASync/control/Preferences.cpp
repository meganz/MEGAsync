...
const char Preferences::USER_AGENT[] = "MEGAsync/1.0.32.1";
const int Preferences::VERSION_CODE = 1032;
const int Preferences::BUILD_ID = 1;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("1.0.32.1");
