...
const char Preferences::USER_AGENT[] = "MEGAsync/2.1.0.2";
const int Preferences::VERSION_CODE = 2100;
const int Preferences::BUILD_ID = 2;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("2.1.0");
const QString Preferences::SDK_ID = QString::fromAscii("4a6d8");
