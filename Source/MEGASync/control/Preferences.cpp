...
const char Preferences::USER_AGENT[] = "MEGAsync/1.0.39.9";
const int Preferences::VERSION_CODE = 1039;
const int Preferences::BUILD_ID = 9;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("1.0.40");
const QString Preferences::SDK_ID = QString::fromAscii("773b3");
