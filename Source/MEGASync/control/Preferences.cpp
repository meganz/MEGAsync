...
const char Preferences::USER_AGENT[] = "MEGAsync/2.0.0.11";
const int Preferences::VERSION_CODE = 2000;
const int Preferences::BUILD_ID = 11;
// Do not change the location of VERSION_STRING, create_tarball.sh parses this file
const QString Preferences::VERSION_STRING = QString::fromAscii("2.0.1k");
const QString Preferences::SDK_ID = QString::fromAscii("61fff");
...
const QString Preferences::HTTPS_ALLOWED_ORIGIN = QString::fromUtf8("*");
