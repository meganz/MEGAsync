...
{
    // Source: http://stackoverflow.com/a/3393525
    ...
    map<string, string>::iterator it = mimemap.find(extension.toStdString());
    if (it == mimemap.end())
    {
        return QString();
    }

    string &mimetype = it->second;

    QString getDefaultAppDesktopFileName = QString::fromUtf8("xdg-mime query default ") + QString::fromUtf8(mimetype.c_str());
    QProcess process;
