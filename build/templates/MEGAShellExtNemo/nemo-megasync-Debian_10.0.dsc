...
Build-Depends: debhelper, intltool, cdbs, qt5-default, qtbase5-dev, libkf5kdelibs4support5-bin, libqt4-dev, autotools-dev, libnemo-extension-dev, libgtk2.0-bin, libtool-bin (>= 2.4.2-1.10) | libtool (<< 2.4.2-1.10)
