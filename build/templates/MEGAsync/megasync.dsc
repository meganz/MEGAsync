...
Build-Depends: debhelper, libqt4-dev, libqt4-dbus, libcrypto++-dev, libc-ares-dev, libssl-dev, libsqlite3-dev, zlib1g-dev, wget, dh-autoreconf, cdbs, unzip, wget, glibc-devel-static
Package-List:
