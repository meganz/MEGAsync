...
add_compile_definitions(
    $<$<CONFIG:Debug>:DEBUG>
    $<$<CONFIG:Debug>:_DEBUG>
    $<$<BOOL:${WIN32}>:NTDDI_VERSION=NTDDI_WIN10> # Supported windows versions: 10 and beyond
    $<$<BOOL:${WIN32}>:_WIN32_WINNT=0x0A00>      # 0x0A00 == Windows 10
    $<$<BOOL:${WIN32}>:PSAPI_VERSION=2>          # PS API version used from Windows 8
)
