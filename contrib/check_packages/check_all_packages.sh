...
URLFED25=http://192.168.122.1:8004
URLFED25i386=http://192.168.122.1:8004
if [ -z $BASEURL ]; then
...
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL FEDORA_25;$URLFED25" #NOTICE: using other repo
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL FEDORA_25_i386;$URLFED25i386" #NOTICE: using other repo
