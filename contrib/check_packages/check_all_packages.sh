...
URLUB1610=$BASEURL/xUbuntu_16.10
if [ -z $BASEURL ]; then
 ...
 URLUB1610=http://192.168.122.1:8003
fi
...
PAIRSVMNAMEREPOURL="$PAIRSVMNAMEREPOURL UBUNTU_16.10_BETA2;$URLUB1610" #NOTICE: using other repo
