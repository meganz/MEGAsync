...
"C:\Program Files (x86)\NSIS\makensis.exe" /DBUILD_UNINSTALLER /DBUILD_X64_VERSION %SUFFIX_DEF% installer_win.nsi
...
"C:\Program Files (x86)\NSIS\makensis.exe" /DBUILD_UNINSTALLER %SUFFIX_DEF% installer_win.nsi
UninstallerGenerator.exe
erase UninstallerGenerator.exe
